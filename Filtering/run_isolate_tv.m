...
iota_mean = mean(sp + L.premium_opt);
...
save(fullfile('output','metrics_A2.mat'),'-struct','m');
fprintf('\n[A2] constant iota=%.0f bps, B lambda/eta: FF %.2f (data %.2f) | DWS %.2f (data %.2f) | |loggap| %.3f\n', ...
