...
h_mod = plot(dates(datesperiod), log(DW_us_t(datesperiod) * 100), ...
    'LineWidth', 2.5, 'Color', 'r'); hold on;
h_dat = plot(dates(datesperiod), log(DW_n(datesperiod) * 100), ...
    'LineWidth', 2.5, 'LineStyle', '-.', 'Color', data_color);
grid on; axis tight;
datetick('x', 'mmm-yy', 'keeplimits');
formataxis(gca);
...
h_mod = plot(dates(datesperiod), log(FF_us_t(datesperiod) * 100), ...
    'LineWidth', 2.5, 'Color', 'r'); hold on;
h_dat = plot(dates(datesperiod), log(FF_n(datesperiod) * 100), ...
    'LineWidth', 2.5, 'LineStyle', '-.', 'Color', data_color);
grid on; axis tight;
datetick('x', 'mmm-yy', 'keeplimits');
formataxis(gca);
