...
Zprob_sigma_us=[P(1,1)*Zprob_sigma_us_r1 P(1,2)*Zprob_sigma_us_r2; P(2,1)*Zprob_sigma_us_r1 P(2,2)*Zprob_sigma_us_r2];
...
[x,fval,exitflag,~]=fsolve(@(x) ...
    ...
    x0,optimoptions('fsolve','Display','off','TolFun',1e-15,'MaxFunctionEvaluations',1e9,'MaxIterations',1e9));
mu_eu_vec = x(1,:);
mu_us_vec = x(2,:);
Rd_eu_vec = x(3,:);
Rd_us_vec = x(4,:);
...
splot1(x_vec(index1),mu_us_vec(index1)); hold on;
splot2(x_vec(index2),mu_us_vec(index2));
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
% ylabel('$liquidity$','interpreter','latex');
formataxis(gca);
...
splot1(x_vec(index1),mu_eu_vec(index1)); hold on;
splot2(x_vec(index2),mu_eu_vec(index2));
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
% ylabel('$liquidity$','interpreter','latex');
formataxis(gca);
...
splot1(x_vec(index1),(Rm_us_vec(index1).^(freq)-1)*rate_scale); hold on;
splot2(x_vec(index2),(Rm_us_vec(index2).^(freq)-1)*rate_scale); 
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
ylabel('bps','interpreter','latex');
formataxis(gca);
...
splot1(x_vec(index1),(pi_us_vec(index1).^(freq)-1)*rate_scale); hold on;
splot2(x_vec(index2),(pi_us_vec(index2).^(freq)-1)*rate_scale); 
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
ylabel('bps','interpreter','latex');
formataxis(gca);
...
splot1(x_vec(index1),(Rm_eu_vec(index1).^(freq)-1)*rate_scale); hold on;
xlim([x_vec(1) x_vec(end)]);
splot2(x_vec(index2),(Rm_eu_vec(index2).^(freq)-1)*rate_scale); 
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
ylabel('bps','interpreter','latex');
formataxis(gca);
...
splot1(x_vec(index1),(Rm_us_vec(index1).^(freq)-1)*rate_scale); hold on;
splot2(x_vec(index2),(Rm_us_vec(index2).^(freq)-1)*rate_scale); 
splot3(x_vec(index1),(Rm_eu_vec(index1).^(freq)-1)*rate_scale); hold on;
splot4(x_vec(index2),(Rm_eu_vec(index2).^(freq)-1)*rate_scale); 
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
ylabel('bps','interpreter','latex');
formataxis(gca);
...
splot1(x_vec(index1),e_euus_vec(index1)/e_mean); hold on;
splot2(x_vec(index2),e_euus_vec(index2)/e_mean); 
xlabel(x_lab,'interpreter','latex');
formataxis(gca);
xlim([x_vec(1) x_vec(end)]);
...
area(x_vec(index1),yLimits(1)+(yLimits(2)-yLimits(1))*invp1/max([invp1; invp2]),'FaceAlpha',0.5,'FaceColor',color_base, 'DisplayName', 'Normal Regime'); hold on;
area(x_vec(index2),yLimits(1)+(yLimits(2)-yLimits(1))*invp2/max([invp1; invp2]),'FaceAlpha',0.5,'FaceColor',color_base2); hold on;
...
area(x_vec(index1),invp1/max([invp1; invp2]),'FaceAlpha',0.5,'FaceColor',color_base, 'DisplayName', 'Normal Regime'); hold on;
area(x_vec(index2),invp2/max([invp1; invp2]),'FaceAlpha',0.5,'FaceColor',color_base2); hold on;
xlabel(x_lab,'interpreter','latex');
formataxis(gca);
xlim([x_vec(1) x_vec(end)]);
...
% splot1(x_vec,(Rd_us_vec.^(freq)-1)*rate_scale); hold on;
% splot2(x_vec,(Rd_eu_vec.^(freq)-1)*rate_scale); 
% xlim([x_vec(1) x_vec(end)]);
% xlabel(x_lab,'interpreter','latex');
% ylabel('bps','interpreter','latex');
% formataxis(gca);
...
splot1(x_vec(index1),(Rb_us_vec(index1).^(freq)-Rm_us_vec(index1).^(freq))*rate_scale); hold on;
xlim([x_vec(1) x_vec(end)]);
splot2(x_vec(index2),(Rb_us_vec(index2).^(freq)-Rm_us_vec(index2).^(freq))*rate_scale);
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
ylabel('bps','interpreter','latex');
formataxis(gca);
...
plot(x_vec(index1),0*Rm_eu_vec(index1), 'LineStyle', '--','Color','k','LineWidth',1); hold on;
aux1=(Rm_eu_vec(index1).^(freq)-Rm_us_vec(index1).^(freq))*rate_scale;
aux2=(Rm_eu_vec(index2).^(freq)-Rm_us_vec(index2).^(freq))*rate_scale;
splot1(x_vec(index1),aux1); hold on;
splot2(x_vec(index2),aux2);
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
ylabel('bps','interpreter','latex');
formataxis(gca);
...
for ii=1:length(index1)-1
    ...
    plot(x_vec(index1(ii:ii+1)),aux1(ii:ii+1),'Color',[0 0 1 alphaVal1],'LineWidth',2); hold on;
    plot(x_vec(index2(ii:ii+1)),aux2(ii:ii+1),'Color',[1 0 1 alphaVal2],'LineWidth',2);
end
%splot3(x_vec(index2),diff);
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
ylabel('bps','interpreter','latex');
formataxis(gca);
...
%% Intensity Plots
figure('Name','Real Rate Differential shade','NumberTitle','off')
plot(x_vec(index1),0*e_euus_vec(index1)+1, 'LineStyle', '--','Color','k','LineWidth',1); hold on;
...
% e_mean=mean(e_euus_vec);
% splot1(x_vec(index1),e_euus_vec(index1)/e_mean); hold on;
splot1(x_vec(index2),e_euus_vec(index2)/e_mean); 
xlabel(x_lab,'interpreter','latex');
formataxis(gca);
xlim([x_vec(1) x_vec(end)]);
%h=legend('Normal Regime','Scrambling Regime','color','none','box','off','location','east','FontSize',20,'AutoUpdate', 'off');
...
aux2=(Rm_eu_vec(index2).^(freq)-Rm_us_vec(index2).^(freq))*rate_scale;
%diff=aux2-aux1;
splot1(x_vec(index1),aux2); hold on;
% splot2(x_vec(index2),aux2);
%splot3(x_vec(index2),diff);
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
...
figure('Name','US Liquidity Ratio','NumberTitle','off'); % Liquidity Ratios
% splot1(x_vec(index1),mu_us_vec(index1)); hold on;
splot1(x_vec(index2),mu_us_vec(index2));
xlim([x_vec(1) x_vec(end)]);
xlabel(x_lab,'interpreter','latex');
% ylabel('$liquidity$','interpreter','latex');
formataxis(gca);
...
plot(x_vec(index1),0*Rm_eu_vec(index1), 'LineStyle', '--','Color','k','LineWidth',1); hold on;
splot1(x_vec(index1),cip_vec(index1)); hold on;
splot2(x_vec(index1),pi_us_ret_vec(index1));
splot3(x_vec(index2),cip_vec(index2)); 
splot4(x_vec(index2),pi_us_ret_vec(index2));
hold off;
%splot3(x_vec(index2),diff);
xlim([x_vec(1) x_vec(end)]);
