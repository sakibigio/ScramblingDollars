...
plot(x_vec ,(Rm_us_vec.^(freq)-1)*100*100,'b', 'linewidth',2.5); hold on;
plot(x_vec,(Rm_eu_vec.^(freq)-1)*100*100, 'linewidth',2.5,'LineStyle','--','color',col_eu);
...
figure;
plot(x_vec ,(Rd_us_vec.^(freq)-1)*100*100,'b', 'linewidth',2.5); hold on;
plot(x_vec,(Rd_eu_vec.^(freq)-1)*100*100, 'linewidth',2.5,'LineStyle','--','color',col_eu);
% 
...
exportfig(gcf,[foldername 'nlmod_BP'],'color','cmyk','resolution',1600);
...
exportfig(gcf,[foldername 'nlmod_UIP'],'color','cmyk','resolution',1600);
